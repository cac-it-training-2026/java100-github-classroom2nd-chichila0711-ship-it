...
public class WarehouseManager {
	...
	public static void main(String[] args) throws IOException {
		...
		//配列の宣言および初期化処理を記述する
		String[] sushiGreet = { "へい！らっしゃい！！", "何にしますか！今日は活きのいいコハダが入ってますよ", "まいどあり！！またどうぞ" };

		System.out.println("Yさん：");
		System.out.println("まず、MISAKI○の今の状態を確かめようかな。\n");

		//三つのあいさつパターンの出力処理を記述する
		for (int i = 0; i < sushiGreet.length; i++) {
			System.out.print("あいさつパターン" + (i + 1) + "...「");
			System.out.println(sushiGreet[i] + "」\n");
		}
		...
		int inputNum = Integer.parseInt(inputNumStr) - 1;

		System.out.print("\nあいさつを吹き込んでください＞");
		String inputGreetStr = br.readLine();

		System.out.println("\nYさん：");
		System.out.println("よし。もう一度確かめてみよう。\n");

		//三つのあいさつパターンの出力処理を記述する
		sushiGreet[inputNum] = inputGreetStr;
		for (int i = 0; i < sushiGreet.length; i++) {
			System.out.print("あいさつパターン" + (i + 1) + "...「");
			System.out.println(sushiGreet[i] + "」\n");
